...
class _$StrategyChoiceImpl implements _StrategyChoice {
  ...
  @override
  String toString() {
    return 'StrategyChoice(action: $action, speech: $speech, successRate: $successRate, reasoning: $reasoning, isSpecial: $isSpecial)';
  }
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, action, speech, successRate, reasoning, isSpecial);
...
abstract class _StrategyChoice implements StrategyChoice {
  const factory _StrategyChoice(
      ...
      final String? speech,
      required final int successRate,
